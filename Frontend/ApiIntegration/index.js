      ...
      document.addEventListener("DOMContentLoaded", function () {
        const isLoggedIn = localStorage.getItem("cozaStoreaccessToken");
        ...
        if (isAdmin === "true") {
          ...
          document
            ...
            .addEventListener("click", async () => {
              try {
                const token = localStorage.getItem("cozaStoreaccessToken");
                if (!token)
                ...
                localStorage.removeItem("cozaStoreaccessToken");
      ...
      async function fetchCart() {
        try {
          const response = await fetch(`${apiBaseUrl}/cart`, {
            method: "GET",
            headers: {
              Authorization: `Bearer ${localStorage.getItem("cozaStoreaccessToken")}`,
            },
          });
      ...
      async function updateQuantity(productId, newQuantity) {
        try {
          const accessToken = localStorage.getItem("cozaStoreaccessToken");
